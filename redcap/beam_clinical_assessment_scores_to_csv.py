...
subj _clinical_report_prep1=str(object=patient_clinical_scores)
...
with open(redcap_report_output, 'wb') as csvfile:
    clinical_assessment_scores_df[0:length_of_data_frame].to_csv(redcap_report_output, index=False, header=False)
