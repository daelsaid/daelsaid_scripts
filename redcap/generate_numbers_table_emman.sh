...
python /Volumes/Smurf-Village/Imaging/best_ptsd/scripts/.scripts/best_numbers_tables_emman_api_05142018.py > /Volumes/Smurf-Village/Imaging/best_ptsd/admin/weekly_dashboards/best_weekly_dashboard_numbers_table_`date "+%Y_%m_%d"`.txt

cat /Volumes/Smurf-Village/Imaging/best_ptsd/admin/weekly_dashboards/best_weekly_dashboard_numbers_table_`date "+%Y_%m_%d"`.txt
