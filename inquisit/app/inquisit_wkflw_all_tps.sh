data_output_path='/Volumes/PATRIOT/RUN_INQUISIT/inquisit_task'
tp1_script_path='/Volumes/PATRIOT/RUN_INQUISIT/inquisit_task/task_script'
tp2_script_path='/Volumes/PATRIOT/RUN_INQUISIT/inquisit_task/task_script_by_form'
...
inquisit_grader () {
    ...
    python /Users/lillyel-said/Desktop/stanford/scripts/inquisit/final/argparse/complete_inquisit_output.py `echo '-r'` "$raw_csv" `echo '-d'` "$demo" `echo '-s'` "$summary" `echo '-o'` "$out"
}
