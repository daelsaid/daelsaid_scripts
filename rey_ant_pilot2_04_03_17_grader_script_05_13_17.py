...
all_subj_data_csv = ('/Users/lillyel-said/Desktop/inquisit/pilot_data/rey_ant_pilot2_17_04_01/data_dir/all_data/rey_ant_pilot2_17_04_01_raw_17_04_28.csv')
data_output_raw_csv = ('/Users/lillyel-said/Desktop/inquisit/pilot_data/rey_ant_pilot2_17_04_01/data_dir/all_data/rey_pilot_04_06_17_parsed_raw_data.csv')
data_output_scored_csv = ('/Users/lillyel-said/Desktop/inquisit/pilot_data/rey_ant_pilot2_17_04_01/data_dir/all_data/rey_pilot_04_06_17_scored.csv')
...
for subj in sorted(set(all_subj_csv_lines['subject'])): 
    try:
        ...
        print "subject %s data screwed up" %subj
        continue
...
for idx,val in enumerate(trial_breaks[:-1]):
        ...
        #if len(set(word_list)) != score:
        #    score=len(set(word_list))
        test=[]
